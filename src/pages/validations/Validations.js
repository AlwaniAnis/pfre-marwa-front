...
import { incidentsMethods, TndevCtx } from "../../contexts/TndevContext";
...
export default function Validations() {
  ...
  const { incidents, setincidents } = states;
      ...
      <Container sx={{ marginTop: 15 }} maxWidth="xl">
        ...
        <Paper sx={{ width: "100%", overflow: "hidden" }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        ...
                        <IconButton
                          onClick={() => handleClickOpenValidationDialog(i.id)}
          ...
          <TablePagination
            ...
            component="div"
            count={incidents?.filter((i) => i.nature === "incident").length}
